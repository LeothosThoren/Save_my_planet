...
import com.leothos.savemyplanet.views.controlers.activities.DetailProductActivity;
...
public class DisplayImageBigSize extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // Retrieve data
        String url = getArguments() != null ? getArguments().getString(DetailProductActivity.BUNDLE_KEY_RESPONSE) : null;
